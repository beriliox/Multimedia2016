...
if(isset($_SESSION['app_id'])) {
  ...
  echo '<div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="views/app/img/upla.jpg" alt="" class="img-responsive portada_error"/>
          </div>
        </div></br></br></br></br>';
  ...
  echo '<div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="views/app/img/valpo.jpg" alt="" class="img-responsive portada_error"/>
          </div>
        </div></br></br></br></br>';
  ...
  echo '<div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="views/app/img/valpo_2.jpg" alt="" class="img-responsive portada_error"/>
          </div>
        </div></br></br></br></br>';
  ...
  echo '<div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="views/app/img/valpo_3.jpg" alt="" class="img-responsive portada_error"/>
          </div>
        </div></br></br></br></br>';
}
